...
public:
	...
	bool isEmpty() const
	{
		return (m_host.isEmpty() || m_domain.isEmpty() || m_account.isEmpty() || m_resource.isEmpty() ||
		        m_password.isEmpty());
	}

	QString jid() const { return m_account + "@" + m_host + "/" + m_resource; }
	QString bareJid() const { return m_account + "@" + m_host; }
